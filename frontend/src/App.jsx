...
const CallUI = ({ callState, localVideoRef, remoteVideoRef, acceptCall, endCall }) => {
    ...
    return (
        <div className="absolute inset-0 max-w-md mx-auto w-full bg-gray-900 z-[100] flex flex-col animate-[slideUp_0.3s_ease-out]">
...
const ClientApp = ({ socket, token }) => {
  ...
  return (
    <div className="bg-bgLight w-full max-w-md mx-auto h-screen md:h-[850px] relative flex flex-col md:rounded-[2.5rem] md:shadow-2xl overflow-hidden text-gray-900">
      ...
      {/* MAIN TABS CONTAINER */}
      <div className="flex-1 overflow-y-auto hide-scrollbar flex flex-col relative w-full max-w-md mx-auto">
        ...
        {activeTab === 'chat' && activeChatRoom && (
          <div className="flex-1 flex flex-col bg-gray-50 relative pb-20 w-full">
            ...
            <div className="absolute bottom-0 w-full max-w-md mx-auto bg-white p-4 border-t border-gray-100 flex items-center gap-2">
                <div className="relative">
            ...
            {viewingLiveMap && (
              <div className="absolute inset-0 bg-white z-30 flex flex-col w-full max-w-md mx-auto">
        ...
        {activeTab === 'chat' && !activeChatRoom && (
            <div className="flex-1 flex flex-col items-center justify-center text-gray-400 pb-28 w-full">
...
const ProfessionalApp = ({ socket, token }) => {
    ...
    return (
        <div className="bg-gray-900 w-full max-w-md mx-auto h-screen md:h-[850px] relative flex flex-col text-white md:rounded-[2.5rem] md:shadow-2xl overflow-hidden">
            ...
            {/* OVERLAYS (MAP) */}
            {viewingMapForJob && (
              <div className="absolute inset-0 w-full max-w-md mx-auto bg-gray-900 z-50 flex flex-col animate-[slideUp_0.3s_ease-out]">
